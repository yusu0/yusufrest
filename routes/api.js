...
loghandler = {
    notparam: {
        ...
        getApikey: 'Mau Apikey?, chat gw di wa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
const listkey = ["Alphabot", "YusufRmdnofc"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'YusufApi') return res.json(loghandler.invalidKey)
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/YusufRmdnofc/Asupan/main/cecan/vietnam.json`))
...
router.get('/cewe/thailand', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/YusufRmdnofc/Asupan/main/cecan/thailand.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/china', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/YusufRmdnofc/Asupan/main/cecan/china.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/indonesia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/YusufRmdnofc/Asupan/main/cecan/indonesia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/korea', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/YusufRmdnofc/Asupan/main/cecan/korea.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/japan', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/YusufRmdnofc/Asupan/main/cecan/japan.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/malaysia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/YusufRmdnofc/Asupan/main/cecan/malaysia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/caklontong', async (req, res, next) => {
	...
	if(apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api.lolhuman.xyz/api/tebak/caklontong?apikey=yusuf01ch1b917cApi`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kuis/tebakgambar', async (req, res, next) => {
	...
	if(apikeyInput != 'YusufzApi' && apikeyInput != 'SpyBotApi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api.lolhuman.xyz/api/tebak/gambar?apikey=yusuf01ch1b917cApi`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
